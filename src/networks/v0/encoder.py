...
class Encoder(nn.Module):
    def __init__(self, input_channels, img_size, latent_dim):
        ...
        self.conv1 = nn.Conv2d(self.input_channels, 32, 5, stride=1, padding=0)
        self.conv2 = nn.Conv2d(32, 64, 5, stride=3, padding=2)
        self.batchnorm = nn.BatchNorm2d(64)

        self.flattened_size = 64 * 20 * 20

        self.linear1 = nn.Linear(self.flattened_size, 4000)
        self.linear2 = nn.Linear(4000, 400)
        self.linear3 = nn.Linear(400, self.latent_dim)
